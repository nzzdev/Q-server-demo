...
const party_slogans_editor_config = {
  label_locales: {
    de: 'Parolenspiegel',
    en: 'party slogans',
  },
  icon: '<svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg"><g fill-rule="evenodd"><path d="M14.7 23.445L11.5 27 5 24.5v-4.45L2 19v1H0v-8h2v1l20-7v20l-7.3-2.555zM11 25l2-2-6.5-2.5V23l4.5 2zM27 16h5v1h-5.027c.018-.331.027-.664.027-1zM26.102 10.37l4.22-2.411c.111.27.217.543.318.818l-4.28 2.446a17.858 17.858 0 0 0-.258-.853zM23.57 5.43l3.27-3.27c.15.183.299.368.444.556l-3.303 3.303c-.133-.2-.27-.396-.41-.59zM23.981 25.981l3.732 3.732c-.14.193-.283.383-.429.571l-3.713-3.713c.14-.194.277-.39.41-.59zM26.102 21.63l4.538 2.593c-.101.275-.207.548-.318.818l-4.516-2.58c.105-.274.204-.551.296-.831z"/></g></svg>',
};

const poll_result_editor_config = {
  label_locales: {
    de: 'Umfrageresultate',
    en: 'poll result',
  },
  icon: '<svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg"><g fill="none" fill-rule="evenodd"><g fill="#000"><path d="M16 0c8.837 0 16 7.163 16 16s-7.163 16-16 16S0 24.837 0 16 7.163 0 16 0zm0 30c7.732 0 14-6.268 14-14S23.732 2 16 2 2 8.268 2 16s6.268 14 14 14z"/><path d="M25.213 6.828L18.85 18.85 6.83 25.213l6.363-12.02 12.021-6.365zM13.9 13.9l-4.95 9.193 9.193-4.95L13.9 13.9z"/></g></g></svg>'
}
...
const tools = {
  ...
  local: {
    ...
    party_slogans: {
      baseUrl: 'http://localhost:3000',
      editor: party_slogans_editor_config,
      endpoint: {
        $filter: 'target',
        $default: false,
        demo1: {
          ...
          stylesheets: [
            {
              url: 'https://service.sophie.nzz.ch/bundle/sophie-q@^1,sophie-font@^1,sophie-color@^1,sophie-viz-color@^1[diverging-6].css'
            },
            {
              content: '.q-item { color: #f5f5f5; background-color: #f5f5f5; }'
            }
        ...
        demo2: {
          ...
          stylesheets: [
            {
              url: 'https://service.sophie.nzz.ch/bundle/sophie-color@^1,sophie-viz-color@^1[diverging-6].css'
            },
            {
              content: '.q-item { color: #f5f5f5; background-color: #f5f5f5; }'
            },
  ...
  production: {
    ...
    poll_result: {
      baseUrl: 'http://q-poll-result:3000',
      editor: election_votes_editor_config,
      endpoint: {
        $filter: 'target',
        $default: false,
